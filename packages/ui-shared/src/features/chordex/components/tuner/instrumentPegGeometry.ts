...
export const INSTRUMENT_GEOMETRIES: Record<string, InstrumentGeometryDefinition> = {
  electric: {
    ...
    pegs: [
      { stringNumber: 6, side: 'left', topPct: 17.5 },
      { stringNumber: 5, side: 'left', topPct: 27.0 },
      { stringNumber: 4, side: 'left', topPct: 36.5 },
      { stringNumber: 3, side: 'left', topPct: 46.0 },
      { stringNumber: 2, side: 'left', topPct: 55.5 },
  ...
  acoustic: {
    ...
    pegs: [
      { stringNumber: 6, side: 'left', topPct: 21.5 },
      { stringNumber: 5, side: 'left', topPct: 33.5 },
      { stringNumber: 4, side: 'left', topPct: 45.5 },
      { stringNumber: 3, side: 'right', topPct: 21.5 },
      { stringNumber: 2, side: 'right', topPct: 33.5 },
      { stringNumber: 1, side: 'right', topPct: 45.5 },
    ],
  },
  'bass-4': {
    mode: 'bass-4',
    ...
    pegs: [
      ...
      { stringNumber: 3, side: 'left', topPct: 31.5 },
      { stringNumber: 2, side: 'left', topPct: 45.0 },
      { stringNumber: 1, side: 'left', topPct: 58.5 },
    ],
  },
};
