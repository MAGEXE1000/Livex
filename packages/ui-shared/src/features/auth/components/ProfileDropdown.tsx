    ...
    <div ref={ref} style={style} className={cn('relative dark', className)}>
      ...
      >
        <div className="flex-1 text-left">
          ...
          <div className="text-xs text-zinc-400 leading-tight tracking-tight">{email}</div>
        </div>
        <div
        ...
        >
            ...
            {menuItems.map((item, idx) => (
              <button
                ...
                className={cn(
                  ...
                  item.disabled &&
                    'cursor-default opacity-50 hover:border-transparent hover:bg-transparent hover:shadow-none'
                )}
                style={{
                  animation: `profile-dd-item-in 180ms ${idx * 40}ms cubic-bezier(0.22,1,0.36,1) both`,
                }}
              >
          ...
          {authUser && (
            <button
              ...
              style={{
                animation: 'profile-dd-item-in 180ms 120ms cubic-bezier(0.22,1,0.36,1) both',
              }}
            >
              <svg
