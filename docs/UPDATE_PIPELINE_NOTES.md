...
## 1. Caching Strategy (Cloudflare Pages)

All web assets are served via Cloudflare Pages. The caching rules are defined in `apps/studio-web/public/_headers` and designed with the following rules:
